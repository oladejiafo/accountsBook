                ...
                <table class="table table-css table-bordered table-hover">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('chartOfAccounts.show', $account->id) }}" class="btn btn-sm btn-secondary">View</a>
                                <a href="{{ route('chartOfAccounts.edit', $account->id) }}" class="btn btn-sm btn-info">Edit</a>
