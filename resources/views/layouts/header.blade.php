...
@media (max-width: 767px) {
    .sidebar-header {
        padding: 0 1rem; /* Add padding to avoid overlap */
    }
    ...
    .navbar-brandcxx {
        margin-top: 1rem; /* Add margin to position the company name below the logo */
    }
}
...
<main id="wrapper">
    ...
    <!-- Logo Section -->
    <div class="sidebar-header-left col-8 col-md-3 d-flex justify-content-center">
        ...
        <a class="navbar-brand titlefont mb-0 d-lg-none" href="{{ route('home') }}">
    ...
    <!-- Company Name Section for small screens -->
