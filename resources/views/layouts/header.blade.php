            ...
            @if (auth()->user()->hasPermission('reconciliation.index') || auth()->user()->hasPermission('chartOfAccounts') || auth()->user()->hasPermission('tax.index') || auth()->user()->hasPermission('transactions.index') || auth()->user()->hasPermission('ledger.index') || auth()->user()->hasRole('Super_Admin'))
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a href="#accountTransactionsSubmenu" data-toggle="collapse"
                                class="dropdown-toggle sidebar-text right-arrow sidebar-button"><i
                                    class="fas fa-book fa-fw" style="margin-right: .75rem"></i> Ledgers</a>
                            <ul class="collapse list-unstyled" id="accountTransactionsSubmenu">
                                ...
                                <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                                        href="{{ route('ledger.index') }}"><i class="fas fa-dot-circle  fa-fw"></i> List
                                        All
                                        Ledgers</a> </li>
                                <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                                ...
                                <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                                        href="{{ route('ledger.accounts_payable_ledger') }}"><i
                                            class="fas fa-dot-circle fa-fw"></i> Accounts Payable Ledger</a>
                                </li>
                            </ul>
                        </li>
                        @endif
                        @if (auth()->user()->hasPermission('transactions.index') || auth()->user()->hasRole('Super_Admin'))
                            <li>
                                <a href="#transSubmenu" data-toggle="collapse"
                                    class="dropdown-toggle sidebar-text right-arrow sidebar-button"><i
                                        class="fas fas fa-exchange-alt fa-fw" style="margin-right: .75rem"></i>
                                    Transactions</a>
                                <ul class="collapse list-unstyled" id="transSubmenu">
                                    <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                                            href="{{ route('transactions.create') }}"><i
                                                class="fas fa-dot-circle  fa-fw"></i>
                        ...
                        @if (auth()->user()->hasPermission('tax.index') || auth()->user()->hasRole('Super_Admin'))
                            <li>
                                <a href="#taxSubmenu" data-toggle="collapse"
                                    class="dropdown-toggle sidebar-text right-arrow sidebar-button"><i
                                        class="fas fa-money-bill-wave fa-fw" style="margin-right: .75rem"></i>
                                    Taxes</a>
                                <ul class="collapse list-unstyled" id="taxSubmenu">
                                    <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                                            href="{{ route('tax-rates.index') }}"><i
                                                class="fas fa-dot-circle  fa-fw"></i> Tax
                                            Rates</a> </li>
                                    <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                                            href="{{ route('tax-transactions.index') }}"><i
                                                class="fas fa-dot-circle  fa-fw"></i> Tax Transactions</a> </li>
                                    <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                                            href="{{ route('tax-payments.index') }}"><i
                                                class="fas fa-dot-circle  fa-fw"></i>
                                            Tax Payments</a> </li>
                                    <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                                            href="{{ route('tax-settings.index') }}"><i
                                                class="fas fa-dot-circle  fa-fw"></i>
                                            Tax Settings</a> </li>
                                    <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                        ...
                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="chartSubmenu">
                                <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                                        href="{{ route('chartOfAccounts') }}"><i
                                            class="fas fa-dot-circle  fa-fw"></i>
                                        Charts of Account</a> </li>
                                <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                                        href="{{ route('chartOfAccounts.create') }}"><i
                                            class="fas fa-dot-circle  fa-fw"></i> Create A New Chart of Account</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="bankingSubmenu">
                                ...
                                <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                                        ...
                                        Deposits</a> </li>
                                <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                                        href="{{ route('withdrawals.index') }}"><i
                                            class="fas fa-dot-circle  fa-fw"></i>
                                        Withdrawals</a> </li>
                            </ul>
                        </li>
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="inventorySubmenu">
                                <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                                        href="{{ route('new-stock') }}"><i class="fas fa-dot-circle  fa-fw"></i> Add
                                        New
                                        Stock</a> </li>
                                <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                        ...
                        <li>
                            ...
                            <ul class="collapse list-unstyled" id="purchaseSubmenu">
                                <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                                        ...
                                        Incoming Stock</a> </li>
                                <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                                        href="{{ route('purchase.index') }}"><i class="fas fa-dot-circle"></i>
                                        Purchases
                                        List</a> </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="#supplierSubmenu" data-toggle="collapse"
                                class="dropdown-toggle sidebar-text right-arrow sidebar-button"><i
                                    class="fas fa-dolly-flatbed  fa-fw" style="margin-right: .75rem"></i>
                                Suppliers</a>
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a href="#saleSubmenu" data-toggle="collapse"
                                class="dropdown-toggle sidebar-text right-arrow sidebar-button"><i
                                    class="fas fa-dollar-sign  fa-fw" style="margin-right: .75rem"></i>
                                Sales/Returns</a>
                            <ul class="collapse list-unstyled" id="saleSubmenu">
                                <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                                        href="{{ route('sales.index') }}"><i class="fas fa-dot-circle  fa-fw"></i>
                                        Sales
                                        Order</a> </li>
                                <li> <a class="sidebar-text sidebar-subitem sidebar-button"
                                        href="{{ route('returns.show') }}"><i class="fas fa-dot-circle  fa-fw"></i>
                                        Sales
                                        Returns</a> </li>
                            </ul>
                        </li>
                ...
                @if (Auth::user()->hasRole('Super_Admin') || Auth::user()->hasRole('Admin'))
                    ...
                    <li> <a class="sidebar-text sidebar-subitemX sidebar-button" href="{% url 'admin:index' %}"><i
                                class="fas fa-cogs" style="margin-right: .75rem"></i> Admin Page</a> </li>
                    <li> <a class="sidebar-text sidebar-subitemX sidebar-button" href="{{ route('users.index') }}"><i
                                class="fas fa-users" style="margin-right: .75rem"></i> Users Management</a> </li>
                    <li> <a class="sidebar-text sidebar-subitemX sidebar-button" href="{{ route('roles.index') }}"><i
                                class="fas fa-user-lock" style="margin-right: .75rem"></i> Roles Management</a> </li>
                    <li> <a class="sidebar-text sidebar-subitemX sidebar-button"
                            href="{{ route('role-permissions.index') }}"><i class="fas fa-user-lock" style="margin-right: .75rem"></i> Roles
                            Permissions</a> </li>
                    <li> <a class="sidebar-text sidebar-subitemX sidebar-button" href="{% url 'admin:index' %}"><i
                                class="fas fa-database" style="margin-right: .75rem"></i> Backup & restore</a> </li>
                @endif
