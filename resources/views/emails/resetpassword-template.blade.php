                            ...
                            <tbody><tr>
                                <td style="box-sizing:border-box;font-family:Yantramanav,sans-serif;max-width:100vw;padding:32px">
                                    <div style="box-sizing:border-box;font-family:Yantramanav,sans-serif;width:400px;height:250px;display:block;margin:30px auto">
                                        <img src="{{asset('images/resetpassword.png')}}" alt="AfriLedger" width="100%" height="100%">
                                    </div>
                                    ...
                                    <p style="box-sizing:border-box;font-family:Yantramanav,sans-serif;font-size:15px;line-height:1.5em;margin-top:0;text-align:left">You are receiving this email because we received a <b style="font-weight: bold">password reset</b> request for your <b style="font-weight: bold">AfriLedger</b> account.</p>
                                    ...
                                    <p style="box-sizing:border-box;font-family:Yantramanav,sans-serif;font-size:15px;line-height:1.5em;margin-top:0;text-align:left">
                                        Do not share this OTP with anyone. AfriLedger takes your account security 
                                        ...
                                        AfriLedger for investigation.</p>
                                    ...
                                    <div style="display: block; margin-top:10px; text-align:center">
                                        <div style="width:40%; display:inline-block;">
                                            ...
                                            float: right;margin-right:15px;">
                                                <img src="{{asset('images/logoo.png')}}" alt="AfriLedger" width="100%" height="100%">
                                            </div>
                                        </div>
