            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('supplier.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="gstin" class="col-md-4 col-form-label text-md-right">GSTIN</label>

                            <div class="col-md-6">
                                <input id="gstin" type="text" class="form-control @error('gstin') is-invalid @enderror" name="gstin" value="{{ old('gstin') }}">
