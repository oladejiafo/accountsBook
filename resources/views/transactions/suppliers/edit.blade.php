            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('supplier.update', $supplier->id) }}">
                        ...
                        <div class="form-group row">
                            <label for="gstin" class="col-md-4 col-form-label text-md-right">GSTIN No</label>

                            <div class="col-md-6">
                                <input id="gstin" type="text" class="form-control @error('gstin') is-invalid @enderror" name="gstin" value="{{ old('gstin', $supplier->gstin) }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                {{-- @endif --}}
                                {{-- @if (isset($delbtn)) --}}
                                    <a href="{{ route('supplier.destroy', $supplier->id) }}" class="btn btn-danger">Delete Supplier</a>
                                {{-- @endif --}}
