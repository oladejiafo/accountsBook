...
@section('content')
    <div class="row" style="color: #575757; font-style: bold; font-size: 3rem;">
        ...
        <div class="col-md-4">               
            <div style="float:right;"> <a class="btn btn-success" href="{{ route('sales.create') }}">New Outgoing Stock</a> </div>
        </div>
    </div>
    ...
    <table class="table table-css table-bordered table-hover"> 
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="align-middle">${{ number_format($sale->totalPrice, 2) }}</td>
